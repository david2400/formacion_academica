...
import com.kleverkids.formacion_academica.modules.control_academico.infrastructure.outbound.persistence.mysql.repository.ObservacionCriterioJpaRepository;
...
public class ObservacionCriterioJpaAdapter implements ObservacionCriterioRepositoryPort {
    ...
    public ObservacionCriterioDto actualizar(ActualizarObservacionCriterioDto request) {
        ObservacionCriterioEntity entity = observacionCriterioJpaRepository.findById(request.getId())
