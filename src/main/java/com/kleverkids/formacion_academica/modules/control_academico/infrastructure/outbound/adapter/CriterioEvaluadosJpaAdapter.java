...
public class CriterioEvaluadosJpaAdapter implements CriterioEvaluadosRepositoryPort {
    ...
    @Override
    public CriterioEvaluadosDto guardar(CrearCriterioEvaluadosDto request) {
    ...
    @Override
    public List<CriterioEvaluadosDto> listarPorExamen(Long examenId) {
        return criterioExamenMapper.toDtoList(criterioExamenJpaRepository.findAll());
    }

    @Override
    public CriterioEvaluadosDto obtenerPorId(Long criterioId) {
