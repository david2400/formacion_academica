...
@RestController
@RequestMapping("/control-academico/criterios-evaluados")
public class CriterioEvaluadosController {

    private final CrearCriterioEvaluadosUseCase crearUseCase;
    private final ActualizarCriterioEvaluadosUseCase actualizarUseCase;
    private final ListarCriteriosPorExamenUseCase listarUseCase;
    private final ConsultarCriterioEvaluadosUseCase consultarUseCase;
    private final EliminarCriterioEvaluadosUseCase eliminarUseCase;
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "Criterio eliminado del examen"),
            @ApiResponse(responseCode = "404", description = "Criterio no encontrado", content = @Content),
            @ApiResponse(responseCode = "500", description = "Error interno", content = @Content)
    })
    @DeleteMapping("/{criterioId}")
    public ResponseEntity<Void> eliminar(@PathVariable Long criterioId) {
